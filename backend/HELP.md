...
* The original package name 'com.lewis.disaster-relief-platform' is invalid and this project uses 'com.lewis.disaster_relief_platform' instead.
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/3.5.10/reference/data/nosql.html#data.nosql.mongodb)
