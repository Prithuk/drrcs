        ...
        <section className="services-section">
          <div className="services-content">
            ...
            <div className="services-grid">
              <article className="service-card" data-animate="fade-up" data-delay="0">
              ...
              <article className="service-card" data-animate="fade-up" data-delay="150">
              ...
              <article className="service-card" data-animate="fade-up" data-delay="300">
              ...
              <article className="service-card" data-animate="fade-up" data-delay="450">
